...
type LabelTrialProps = {
  daysRemaining: number
}

export function LabelTrial({ daysRemaining }: LabelTrialProps) {
  return (
      ...
      <CardContent className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="font-medium text-sm text-yellow-800 dark:text-yellow-300">
            Você está aproveitando o período de teste. Faltam {daysRemaining} {daysRemaining === 1 ? 'dia' : 'dias'} para o seu
            plano expirar.
          </p>
